 ...
 */
final class Version20180802172618 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ouvrage_user (ouvrage_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_9799C8C315D884B5 (ouvrage_id), INDEX IDX_9799C8C3A76ED395 (user_id), PRIMARY KEY(ouvrage_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
